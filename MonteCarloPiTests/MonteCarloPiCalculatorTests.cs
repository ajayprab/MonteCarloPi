...
namespace MonteCarloPiTests
{
    ...
    public class MonteCarloPiCalculatorTests : TestBase
    {
        ...
        [Test]
        public void when_getvalueofpi_is_called_with_three_points_pi_is_approximated_as_expected()
        {
            var monteCarloPiCalculator = AutoMock.Resolve<MonteCarloPiCalculator>();
            Assert.That(monteCarloPiCalculator.GetValueOfPi(3), Is.EqualTo(2));
